...
export const globalSportsNews = await fetchTopHeadlines("sports");
export const globalTechNews = await fetchTopHeadlines("technology");
export const globalBusinessNews = await fetchTopHeadlines("business");
